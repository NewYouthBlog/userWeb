...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"一个极简的博客"},{"name":"keywords","content":"博客,前端,后端,技术,go,gin,python,vue,glong"}],"link":[{"rel":"icon","type":"image/x-icon","href":"favicon.ico"}],"style":[],"script":[],"noscript":[],"charset":"utf-8","title":"星河的博客"};
