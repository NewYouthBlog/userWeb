...
import { a3 as fetchDefaults, a1 as asyncDataDefaults, a2 as useNuxtApp, c as createError } from '../server.mjs';
...
const request = async (path) => {
  return await useFetch(`http://127.0.0.1:3001${path}`, "$fDcCtFZyN0");
};

export { request as r };
//# sourceMappingURL=requests-81cacf38.mjs.map
